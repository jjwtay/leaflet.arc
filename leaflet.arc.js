...
L.Arc = L.Polyline.extend({
    ...
    setRhumb: function setRhumb () {
        let rhumb = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 45
...
L.arc = function (_ref2) {
    ...
    return new L.Arc(_extends({ center, radius, rhumb, startBearing, numberOfPoints, endBearing }, options))
};
